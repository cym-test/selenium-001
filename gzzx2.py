...
def get_csv_data():
    value_rows=[]
    with open('data02.csv', encoding='UTF-8') as f:
        f_csv = csv.reader(f)
        next(f_csv)
        for r in f_csv:
            value_rows.append(r)
...
class TestDemo(unittest.TestCase):
      ...
      def test1_demo(self,gnum,gname,gjc):
          ...
          time.sleep(2)
          self.driver.find_element_by_class_name('el-input__inner').send_keys(gnum)
          time.sleep(2)
          self.driver.find_element_by_css_selector('#app > div > div > div.container-box > div.router-box > div > div > div > div.box-part > div > div > div.form-main.border-bottom > div > form > div:nth-child(1) > div:nth-child(2) > div > div.el-form-item__content > div > input').send_keys(gname)
          time.sleep(2)
          self.driver.find_element_by_css_selector('#app > div > div > div.container-box > div.router-box > div > div > div > div.box-part > div > div > div.form-main.border-bottom > div > form > div:nth-child(1) > div:nth-child(3) > div > div.el-form-item__content > div > input').send_keys(gjc)
          #点击“类型”下拉框
